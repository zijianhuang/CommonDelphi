...
// File generated on 02-4-21 10:09:36 from Type Library described below.
...
// DepndLst: 
//   (1) v2.0 stdole, (C:\PWIN98\SYSTEM\STDOLE2.TLB)
//   (2) v2.1 Office, (C:\PROGRAM FILES\MICROSOFT OFFICE\OFFICE\MSO9.DLL)
//   (3) v4.0 StdVCL, (C:\PWIN98\SYSTEM\STDVCL40.DLL)
// Errors:
...
// *********************************************************************//
  ...
  TOutlookApplicationItemSend = procedure(Sender: TObject; var Item: OleVariant;
                                                           var Cancel: OleVariant) of object;
  TOutlookApplicationReminder = procedure(Sender: TObject; var Item: OleVariant) of object;
  TOutlookApplicationOptionsPagesAdd = procedure(Sender: TObject; var Pages: OleVariant) of object;
...
begin
  case DispID of
   ...
   61442: if Assigned(FOnItemSend) then
            FOnItemSend(Self, Params[0] {const IDispatch}, Params[1] {var WordBool});
   ...
   61445: if Assigned(FOnOptionsPagesAdd) then
            FOnOptionsPagesAdd(Self, Params[0] {const PropertyPages});
...
begin
  Result := DefaultInterface.Get_Session;
end;
...
begin
  Result := DefaultInterface.Get_Explorers;
end;

function  TOutlookApplication.Get_Inspectors: _Inspectors;
begin
  Result := DefaultInterface.Get_Inspectors;
end;
...
begin
  Result := DefaultInterface.Get_FeatureInstall;
end;
...
procedure Register;
begin
  RegisterComponents('ActiveX',[TOutlookApplication]);
end;
