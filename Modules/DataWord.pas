...
uses
  Word_TLB, Office_Tlb,Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
  OleServer, 
   syncobjs, ActiveX, db, variants;
...
type
  ...
  TWordUtilBase = class (TDataModule)
...
begin
  ...
  try
    temp:=WordApp.Documents.Open(ut1, EmptyParam, EmptyParam, ut4, EmptyParam, EmptyParam,
     EmptyParam, EmptyParam, EmptyParam, ut10, ut11, ut12, EmptyParam, EmptyParam, EmptyParam, EmptyParam);
    Result:=temp;
  except
